export default {
  paper: [
    {
      cover: 'src/assets/publications/storydrawer_chi22/cover.jpg',
      animation: 'src/assets/publications/storydrawer_chi22/animation.gif',
      title:
      ...
      pdf: 'src/assets/publications/storydrawer_chi22/storydrawer_chi22.pdf',
    ...
    {
      cover: 'src/assets/publications/sspoon_imwut22/cover.jpg',
      animation: 'src/assets/publications/sspoon_imwut22/animation.gif',
      title:
      ...
      pdf: 'src/assets/publications/sspoon_imwut22/sspoon_imwut22.pdf',
      link: { acm: 'https://dl.acm.org/doi/abs/10.1145/3550312' },
      video: '',
      talk: ''
    },
    {
      cover: 'src/assets/publications/electropaper_electronics21/cover.jpg',
      animation:
        'src/assets/publications/electropaper_electronics21/animation.gif',
      title:
      ...
      pdf: 'src/assets/publications/electropaper_electronics21/electropaper_electronics21.pdf',
  ...
  poster: [
    {
      cover: 'src/assets/publications/musiccollage_hcii22/cover.jpg',
      animation: 'src/assets/publications/musiccollage_hcii22/animation.gif',
      title:
      ...
      pdf: 'src/assets/publications/musiccollage_hcii22/musiccollage_hcii22.pdf',
      link: {
        springer:
    ...
    {
      cover: 'src/assets/publications/camfi_chi22/cover.jpg',
      animation: 'src/assets/publications/camfi_chi22/animation.gif',
      title:
      ...
      venue:
        '2022 International Conference on Human-Computer Interaction (HCII 2022)',
      pdf: 'src/assets/publications/camfi_chi22/camfi_chi22.pdf',
      link: {
    ...
    {
      cover: 'src/assets/publications/biosketchbook_idc21/cover.jpg',
      animation: 'src/assets/publications/biosketchbook_idc21/animation.gif',
      title:
      ...
      pdf: 'src/assets/publications/biosketchbook_idc21/biosketchbook_idc21.pdf',
      link: {
    ...
    {
      cover: 'src/assets/publications/storydrawer_chi21/cover.jpg',
      animation: 'src/assets/publications/storydrawer_chi21/animation.gif',
      title:
      ...
      pdf: 'src/assets/publications/storydrawer_chi21/storydrawer_chi21.pdf',
      link: {
    ...
    {
      cover: 'src/assets/publications/colorguardian_chi21/cover.jpg',
      animation: 'src/assets/publications/colorguardian_chi21/animation.gif',
      ...
      venue:
        'Extended Abstracts of the 2021 ACM Interaction Design and Children Conference (IDC EA 2021)',
      pdf: 'src/assets/publications/colorguardian_chi21/colorguardian_chi21.pdf',
      link: {
        acm: 'https://dl.acm.org/doi/fullHtml/10.1145/3459990.3465197'
      },
      video: '',
